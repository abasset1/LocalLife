...
Tickets terminés (Sprint 2) : LL-2001 (structure du module User — domain/application/infrastructure, aucun code métier à ce stade).

Prochaine tâche

Traiter LL-2002 — Créer l'entité User.

Objectifs :

Champs : `id`, `username`, `email`, `createdAt`. Entité à valider par le lead dev (toi) avant de passer à LL-2003 (migration Flyway).
